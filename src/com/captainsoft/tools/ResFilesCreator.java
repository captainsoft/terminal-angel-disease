...
/**
 * Creates the ".vrs" and ".srs" graphic and sound files. For german and english.
 * Puts them into the correct directory.
 *
 * @author Mathias Fringes
 */
public class ResFilesCreator {

    // fields

    private String soundSourceFolder = "snd"; //"snd/sic_(low)";

    // constructors

    public ResFilesCreator() {
        super();
        ...
        final String destFolder = BasePathDest + "files/res";

        final String sourceFolder_en = BasePathOrig + "files_source_en";
        final String destFolder_en = BasePathDest + "files_en/res";
