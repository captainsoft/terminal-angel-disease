...
public final class Outro extends CutScene {
    ...
    public Animation createAnimation(int index) {
        switch (index) {
            case 1:
                return thatWasTheGame().createAnimation();
            case 2:
                return madeBy().createAnimation();
            case 3:
                return playedBy().createAnimation();
            case 4:
                return starringScene().createAnimation();
            case 5:
                return alsoStarringScene().createAnimation();
            case 6:
                return cakeGuysTalk().createAnimation();
            case 7:
                return thankYouScene().createAnimation();
            case 8:
                return valloSchnauffIndianaJonesTetScene().createAnimation();
            case 9:
                return captainsoftEndorsementScene().createAnimation();
            case 10:
                return starsConversationScene().createAnimation();
            case 11:
                return endAndTeaserScene().createAnimation();
            case 12:
                return freitagmanLastThingScene().createAnimation();
            case 13:
                return copyRightScene().createAnimation();
            default:
                return null;
        }
    }
