...
public final class Intro extends CutScene {
	...
	public Animation createAnimation(int index) {	
		switch (index) {							
			case  1: return captainsoftLogoScene().createAnimation(); 
			case  2: return thisIsTheStory().createAnimation();
			case  3: return formerHomeOf().createAnimation();			
			case  4: return fatHeroesDrinking().createAnimation();
			case  5: return untilThisDay().createAnimation();
			case  6: return monsterDance().createAnimation();
			case  7: return verhaltensweisenTalk().createAnimation();
			case  8: return partyIntroducing().createAnimation();
			case  9: return tadLogo().createAnimation();
			case 10: return irrlichtMove().createAnimation();
			case 11: return goOnToActionWorld().createAnimation();																			
			default:
				return null;
		}
	}
