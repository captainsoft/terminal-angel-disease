...
import static com.captainsoft.TADr.loader.vbFile.VbFileUtils.decodeText;
import static com.captainsoft.TADr.loader.vbFile.VbFileUtils.turnInt;
import static com.captainsoft.TADr.loader.vbFile.VbFileUtils.turnShort;
...
/**
 * Encapsulates the old visual basic file format.
 *
...
public final class VbFile implements Closeable {
	...
	public void seekRecord(int chunk, int record) throws IOException {
		if (recordSize < 1) {
		...
		int position = (chunk - 1) * (chunkSize * recordSize) + (record - 1) * recordSize;
	    file.seek(position);
	}
	...
	public void writeShort(int value) throws IOException {
		...
		file.writeByte((value & 0x0000FF00) >> 8);
	}
