...
final class SettingsPanel extends JPanel {
	...
	private JPanel createViewTwo(Translator translator) {		
		...
		pnl.add(capt);
		//
		walkSpeedSlider = new JSlider(30, 130);
		walkSpeedSlider.setBounds(10, 80, 130, 42);		
		walkSpeedSlider.setExtent(10);	
		walkSpeedSlider.setFont(cursiveFont);
		walkSpeedSlider.setInverted(true);
		walkSpeedSlider.setMinorTickSpacing(10);
		walkSpeedSlider.setPaintLabels(true);
		walkSpeedSlider.setPaintTicks(true);
		//
		Hashtable<Integer, JLabel> labelTable = new Hashtable<Integer, JLabel>();
		labelTable.put(new Integer(30), createDefLabel(translator.word("menu.settings.walkFast")));
		labelTable.put(new Integer(130), createDefLabel(translator.word("menu.settings.walkSlow")));		
